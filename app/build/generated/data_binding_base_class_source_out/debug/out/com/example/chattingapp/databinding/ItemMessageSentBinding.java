...
public final class ItemMessageSentBinding implements ViewBinding {
  ...
  private ItemMessageSentBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageView imageMessageBody, @NonNull TextView textMessageBody) {
  ...
  public static ItemMessageSentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageSentBinding((ConstraintLayout) rootView, audioLayout, audioSeekbar,
          audioTimer, btnPlayAudio, imageMessageBody, textMessageBody);
    }
